...
removeLastFlavor(oringnalFlavors);
...
removeFlavorByName(oringnalFlavors,"Vanilla");
...
console.log(copy(oringnalFlavors,newFlavor))
...
console.log(filterByWord(oringnalFlavors,"Chocolate"))
}
